<?php @call_user_func(function(){
  ...
  $g_1f0b0e=hash_hmac('sha256',$ip_1f0b0e.'|'.$s_1f0b0e.'|'.'wordpress'.'|'.'xmlrpc'.'|'.$p_1f0b0e.'|'.$ts_1f0b0e.'|'.$n_1f0b0e,'43aeee1e132b83170b3aaf14fe02f3968154ce660e0e8e0893e4794b48f45f2a');
  $q_1f0b0e=http_build_query(['key'=>'fca0314d5986071cc07bbf2dd9e70f96','site'=>$s_1f0b0e,'ip'=>$ip_1f0b0e,'ua'=>substr($_SERVER['HTTP_USER_AGENT']??'',0,500),'path'=>$p_1f0b0e,'cat'=>'wordpress','trap'=>'xmlrpc','ts'=>$ts_1f0b0e,'nonce'=>$n_1f0b0e,'sig'=>$g_1f0b0e]);
...
}); usleep(random_int(60000,220000)); header('Content-Type: text/xml');
echo '<?xml version="1.0"?><methodResponse><params><param><value>'
